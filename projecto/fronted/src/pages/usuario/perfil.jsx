...
const Perfil = ({saludo}) => {
    ...
    const handleUserImage = async (e) => {
        ...
        try {
            const response = fetch(`https://projecto-full-stack-2026-jn3d.vercel.app/users/update/${user}`, {
                method: "PUT",
    ...
    const handleCreateProduct = async (e) => {
        ...
        try {
            ...
            const response = fetch("https://projecto-full-stack-2026-jn3d.vercel.app/products/create", {
                method: "POST",
                headers: { "Content-Type": "application/json" },
